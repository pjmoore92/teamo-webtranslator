...
in the following diagram (Figure ~\ref{fig:website-structure}). 
...
There are four primary elements in the site, and each of these may
...
\textbf{Bethal Translation}
\begin{itemize}
\item \textbf{Description}

The Train Timetable screen enables the user to specify a rail line
and day of week.
On submitting, the [project name] displays the requested timetable in
the popup window.

\item \textbf{Navigation}

[A brief description of how this page or screen is accessed.]
Navigation to the screen is by clicking the ‘Train’ link in the
