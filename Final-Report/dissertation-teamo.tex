...
and straightford when updating the client on our progress. We accomplished this
...
Footer:
\marginpar{Why are these important?}
\begin{itemize} \itemsep1pt \parskip0pt \parsep0pt
...
The main page provides navigation links to all
other pages. It shows the welcome message from the translator.
...
come up with the  \textbf{Main Template}
(Figure ~\ref{wireframes:main-template}).
...
\begin{center}
\includegraphics[width=\linewidth, trim = 0px 110px 0px 100px, clip=true]
	{wireframes/about}
...
\begin{figure}
\begin{center}
\vspace{-40pt} %trims the whitespace on the top of the page
\includegraphics[width=\linewidth, trim = 0px 40px 0px 40px, clip=true]
...
The contact page (Figure \ref{wireframes:contact}) is the page that a customer
may use to contact the translator
for general enquiries or getting a quote for services other than document
translating that the translator offers. 
...
\begin{center}
\vspace{-40pt} %trims the whitespace on the top of the page
\includegraphics[width=\linewidth, trim = 0px 0px 0px 0px, clip=true]
	{wireframes/contact}
...
\begin{itemize}
\item \textbf{Description}
%What we've changed from Wireframes:
%  * taken down additional contact information, at the translator's request.
%  * 
\item \textbf{Navigation}
...
that we entice them somehow into commiting to the process of signing up and submitting documents for translation.
...
interacting with and tracking their documents intuitive and responsive. The
colours used, layout of the pages and the browser features employed (such as
