...
After laying out the process of the website we focused on creating wireframes.
...
\begin{figure}
\centering
\includegraphics[height=200px, trim=10px 400px 10px 150px]{website-structure}
