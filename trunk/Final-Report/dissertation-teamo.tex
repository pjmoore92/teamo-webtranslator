...
However, it is always possible to support payment using some other currencies.
...
One thing we may provide in any future is more detailed tracking of users in the
administrative dashboard. With this enhanced functionality, the translator would
be able to select a particular user and view their past business history with
him. This is very achieveable with the modular approach we took to handling
