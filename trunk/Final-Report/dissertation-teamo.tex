...
We decided to make the registration process a three step process so as to make it as simple as possible for a first time user.
...
to achieve their goal. Some simple JavaScript check was then enforced such that if the hidden forms 
were filled in, the page wouldn't allow the registration or contact query to go through. 
