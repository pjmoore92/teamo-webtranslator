...
class Dashboard extends MY_Controller {
	...
	public function pending(){
		...
		$this->load->model('job_model');
		$this->_data['pending_jobs_list'] = $this->job_model->get_all_pending($this->_user_id);

		$this->_data['content'] = "dashboard/{$this->_data['role']}/pending";
  ...
  public function quotes(){
		...
		$this->load->model('job_model');
		$this->_data['quoted_jobs_list'] = $this->job_model->get_all_quoted($this->_user_id);

		$this->_data['content'] = "dashboard/{$this->_data['role']}/quotes";
  ...
  public function translations(){
		...
		$this->load->model('job_model');
		$this->_data['translated_jobs_list'] = $this->job_model->get_all_translated($this->_user_id);

		$this->_data['content'] = "dashboard/{$this->_data['role']}/translations";
  ...
  public function history(){
		...
		$this->load->model('job_model');
		$this->_data['historic_jobs_list'] = $this->job_model->get_all_history($this->_user_id);

		$this->_data['content'] = "dashboard/{$this->_data['role']}/history";
