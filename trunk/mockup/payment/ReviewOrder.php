...
if(! isset($token)) {
		...
		/* The servername and serverport tells PayPal where the buyer
		 ...
		 /* The returnURL is the location where buyers return when a
		   ...
		   $cancelURL =urlencode("$url/index.html" );
		 ...
		 /* Construct the parameter string that describes the PayPal payment
           ...
           $paymentAmount = 5.00+2.00+1.00+$itemamt;
           $maxamt= $paymentAmount+25.00;
           $nvpstr="";
           ...
           $nvpstr="&ADDRESSOVERRIDE=1$shiptoAddress&L_NAME0=".$L_NAME0."&L_AMT0=".$L_AMT0."&L_QTY0=".$L_QTY0."&MAXAMT=".(string)$maxamt."&AMT=".(string)$paymentAmount."&ITEMAMT=".(string)$itemamt."&CALLBACKTIMEOUT=4&L_SHIPPINGOPTIONAMOUNT1=8.00&L_SHIPPINGOPTIONlABEL1=UPS Next Day Air&L_SHIPPINGOPTIONNAME1=UPS Air&L_SHIPPINGOPTIONISDEFAULT1=true&L_SHIPPINGOPTIONAMOUNT0=3.00&L_SHIPPINGOPTIONLABEL0=UPS Ground 7 Days&L_SHIPPINGOPTIONNAME0=Ground&L_SHIPPINGOPTIONISDEFAULT0=false&INSURANCEAMT=1.00&INSURANCEOPTIONOFFERED=true&CALLBACK=https://www.ppcallback.com/callback.pl&SHIPPINGAMT=0.00&SHIPDISCAMT=0.00&TAXAMT=2.00&L_NUMBER0=1000&L_DESC0=Size: 8.8-oz&ReturnUrl=".$returnURL."&CANCELURL=".$cancelURL ."&CURRENCYCODE=".$currencyCodeType."&PAYMENTACTION=".$paymentType;
