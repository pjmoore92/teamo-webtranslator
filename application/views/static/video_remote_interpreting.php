...
<div class="page-header">
  <h1 class="active">Bethel Translations <small>Remote Video Interpretation Service</small></h1>
</div>
<div class="row">
  <div class="span10">
    <h2>Video Interp</h2>
    ...
    <p style="text-align: center"> 
  		<br>
  		<br>
  		<a class="btn btn-success btn-large" href="/contact/video_translation">Get A Quote Here</a></p>
  </div>
